export default function ContactPage() {
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Create mailto link
    const mailtoLink = `mailto:garimasharma@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBody)}`;
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-12">
        ...
        <div className="text-center mb-16 animate-fade-in-down">
          ...
          <p className="dark:text-slate-400 text-slate-600 max-w-2xl mx-auto">
            I'm currently open to tutoring opportunities. Whether you're looking for help 
            with your studies or want to discuss educational support, feel free to reach out!
          </p>
        </div>
          ...
          <div className="space-y-8 animate-fade-in-left">
            <div className="flex items-start gap-4 hover:translate-x-2 transition-transform duration-300">
              ...
              <div>
                ...
                <a href="mailto:garimasharma@gmail.com" className="dark:text-slate-400 text-slate-600 hover:text-emerald-400 transition-colors">
                  garimasharma@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-400 font-medium">Available for tutoring</p>
              </div>
            </div>
